...
// Mallow@Changes 09-04-26 --- Inject buffer into unifiedResponse.data to support proper rendering of rich messages (ex: tables and code blocks)
                        ...
                        view_model: {
                            primitives: submessage.contentItemsMetadata.itemsMetadata.map((item) => {
                                ...
                                return {
                                    ...
                                    creator: reelItem.creator || '@itsMallowaa/baileys',
...
export const prepareRichResponseMessage = (content) => {
    ...
    // Mallow@Note 17-04-26 --- TODO: Fill mediaDetailsMetadataList and sources field
...
// Mallow@Note 17-04-26 --- signature and certificateChain for proofs[] field
...
export const wrapToBotForwardedMessage = (richResponseMessage) =>
    ({
        messageContextInfo: {
            botMetadata: {
                pluginMetadata: {},
                // Mallow@Note 09-04-26 --- TODO: Fill verificationMetadata field
