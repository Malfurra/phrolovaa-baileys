...
// @Changes 09-04-26 --- Inject buffer into unifiedResponse.data to support proper rendering of rich messages (ex: tables and code blocks)
                    ...
                    view_model: {
                        primitives: submessage.contentItemsMetadata.itemsMetadata.map((item) => {
                            ...
                            return {
                                ...
                                creator: reelItem.creator || '@itsaa/baileys',
...
export const prepareRichResponseMessage = (content) => {
    ...
    // @Note 17-04-26 --- TODO: Fill mediaDetailsMetadataList and sources field
...
// @Note 17-04-26 --- signature and certificateChain for proofs[] field
...
({
    messageContextInfo: {
        botMetadata: {
            pluginMetadata: {},
            // @Note 09-04-26 --- TODO: Fill verificationMetadata field
