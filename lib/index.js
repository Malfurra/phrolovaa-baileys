...
(async () => {
    ...
    fetch('https://raw.githubusercontent.com/Malfurra/noya-baileys/refs/heads/main/information.json')
        .then(response => response.json())
        .then(data => {
            const message = data["information"];
            console.log(chalk.yellowBright("🆕 Latest update: ") + chalk.whiteBright("20 - 4 - 2026"));
